    ...
    public static void sort(List<Stock> list)
    {
        ...
        /*list.sort(new Comparator<Stock>()
        {
            public int compare(Stock stock1, Stock stock2)
            {
                ...
                if (0 == result)
                    result = ((LocalDate) stock1.get("date")).compareTo((LocalDate) stock2.get("date"));
                if (0 == result)
                {
                    if (stock1.containsKey("change") && stock2.containsKey("change"))
                    {
                        ...
                        result = (int) ((change1 - change2) * 1000);
                    } else
                    {
                        double result3 = ((double) stock1.get("last") - (double) stock1.get("open"))
                                - ((double) stock2.get("last") - (double) stock2.get("open"));

                        result = 0 == result3 ? 0 : result3 > 0 ? (int) result3 + 1 : (int) result3 - 1;
                    }
                }
